...
namespace Sakaji_Hajar_a3_project
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int enemyPositions = 0; enemyPositions < numberOfEnemies; enemyPositions++)
            {
                enemies[enemyPositions] = new Vector2(screenWidth + enemyPositions * 200, screenHeight - characterSize);
            }
